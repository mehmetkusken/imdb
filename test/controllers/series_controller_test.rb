...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { description: @series.description, genre: @series.genre, image: @series.image, rating: @series.rating, title: @series.title, year: @series.year } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { description: @series.description, genre: @series.genre, image: @series.image, rating: @series.rating, title: @series.title, year: @series.year } }
